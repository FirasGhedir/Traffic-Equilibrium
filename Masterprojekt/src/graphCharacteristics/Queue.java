...
public class Queue<T> {
	 ...
	 * @exception java.lang.InterruptedException if any thread has interrupted this
	 *            thread.
	 */
	 ...
	 * 
	 * @param timeOut the number of milliseconds to wait for something to arrive.
	 *
	 * @return the oldest object on the queue.
	 * @exception java.lang.InterruptedException if any thread has interrupted this
	 *            thread.
	...
	/**
	 * Returns an enumeration of the elements in Last-In, First-Out order. Use the
	...
	/**
	 * Returns an enumeration of the elements in First-In, First-Out order. Use the
	 * Enumeration methods on the returned object to fetch the elements
	 * sequentially.
	 */
