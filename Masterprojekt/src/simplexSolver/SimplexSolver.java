 ...
 * 
 *          The Following solves a linear programming problem in standardized
...
public class SimplexSolver {
	...
	public SimplexSolver(int numOfConstraints, int numOfUnknowns) {
	...
	/**
	 * computes the values of the simplex tableau should be use in a loop to
	 * continously compute until an optimal solution is found
	 * 
	 ...
	 * 
	 * @param pivotRow
	 *            the pivot element of the row
	 * @param pivotColumn
	 *            the pivot element of the column
	 */
	 ...
	 *            the column
	 * 
	 * @return float array of calculated ratios
	 */
	 ...
	 * 
	 * @return integer value (index) of the entering column
	 */
	 ...
	 *            float array of data
	 * 
	 * @return the smallest value as integer value
	 */
	 ...
	 * 
	 * @param data
	 *            the data of the given float array
	 * 
	 * @return the largest value as integer value
	 */
	 ...
	 * 
	 * @return true, if optimality is given
	 */
	 ...
	 * 
	 * @return the 2D table of float values
	 */
